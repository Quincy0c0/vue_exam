...
import GeneralCard from './components/FirstComps/GeneralCard.vue';

import SalesGrowChart from './components/FirstComps/SalesGrowChart.vue';

import TradeNumberChart from './components/FirstComps/TradeNumberChart.vue';
